...
export const TourProvider = ({ children, setActiveTab }: { children?: ReactNode, setActiveTab: (tab: string) => void }) => {
    ...
    const steps: TourStep[] = [
        ...
        { targetId: 'risk-settings', titleKey: 'riskSettings', contentKey: 'riskSettingsDesc', position: 'right', tabId: 'risk' },
        { targetId: 'risk-simulator', titleKey: 'riskSimulator', contentKey: 'riskSimulatorDesc', position: 'top', tabId: 'risk' },
