...
const CsvImportPage: React.FC<Props> = ({
  ...
  if (step === 'upload') return (
    <div className="csv-page" style={{ minHeight: '100vh', background: '#f5f5ff', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      {navChrome()}
